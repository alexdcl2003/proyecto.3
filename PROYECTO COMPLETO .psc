...
Funcion ejercicio_11_EI
	// Definir variables
    Definir edad, peso, estatura, contadorEdad18_25, contadorMayores36 Como Entero
    ...
    // Leer datos de la muestra
    Escribir "Ingrese la edad, peso y estatura (separados por espacios) de cada persona (ingrese 0 para terminar):"
    ...
    // Calcular promedios
    promedioEdad <- sumaEdad / (contadorEdad18_25 + contadorMayores36)
    promedioPeso <- sumaPeso / (contadorEdad18_25 + contadorMayores36)
    promedioEstatura <- sumaEstatura / (contadorEdad18_25 + contadorMayores36)
	
    // Calcular promedio de peso de personas con edades entre 18 y 35 años
    Si contadorEdad18_25 > 0 Entonces
        promedioPeso18_35 <- sumaPeso / contadorEdad18_25
    Sino
        promedioPeso18_35 <- 0
    Fin Si
    ...
    Escribir "Cantidad de personas con edad entre 18 y 25 años:", contadorEdad18_25
